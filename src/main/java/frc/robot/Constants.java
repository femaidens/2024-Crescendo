...
public final class Constants {
  ...
  public static final class ShooterAngleConstants {
    ...
    // pid -> need to populate
    public static final double kP = 0.11;  //0.11
    public static final double kI = 0.005; //0
    public static final double kD = 0;

    public static final double kS = 0.1368; //0.1902; //0.13601;
    public static final double kV = 0.0015084; //0.0013292; // 0.001622;
    public static final double kA = 0.00075022; //0.00083976; //0.00050685;
    public static final double kG = 1.5529; //2.159; // 1.0622;
