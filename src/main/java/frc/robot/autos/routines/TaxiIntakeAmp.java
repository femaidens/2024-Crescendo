...
public class TaxiIntakeAmp extends SequentialCommandGroup {
  /** Creates a new TaxiIntake1. */
  public TaxiIntakeAmp(Drivetrain drivetrain, Intaking intaking, ShooterAngle shooterAngle, ShooterWheel shooterWheel, Hopper hopper) {
    ...
    addCommands(
      ...
      new AutonShoot(ShooterAngleConstants.AMP_FLUSH, 2, ShooterWheelConstants.AMP_FLUSH, HopperConstants.TRANSITION_VEL, hopper, shooterAngle, shooterWheel).asProxy());
  }
}
