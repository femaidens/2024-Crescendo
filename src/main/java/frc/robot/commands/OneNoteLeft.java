...
public class OneNoteLeft extends SequentialCommandGroup{
    ...
    public OneNoteLeft(Drivetrain drivetrain, Intaking intaking, Shooter shooter){
        //List<PathPlannerPath> pathGroup = PathPlannerAuto.getPathGroupFromAutoFile("three note flush");
        ...
        addCommands(
            AutoBuilder.buildAuto("left one note")
        );
