...
public class Drivetrain extends SubsystemBase {
  ...
  private SlewRateLimiter m_magLimiter = new SlewRateLimiter(DriveConstants.MAG_SLEW_RATE);
  private SlewRateLimiter m_rotLimiter = new SlewRateLimiter(DriveConstants.ROT_SLEW_RATE);
  ...
  public double getTurnRate() {
    return gyro.getRate(IMUAxis.kZ) * (DrivetrainConstants.kGyroReversed ? -1.0 : 1.0);
  }
}