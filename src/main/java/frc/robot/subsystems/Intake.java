...
public class Intake extends SubsystemBase {
  ...
  public Intake() {
    ...
    // intakePIDController = new
    // PIDController(Constants.IntakeConstants.PIDConstants.kP,
    // Constants.IntakeConstants.PIDConstants.kI,
    // Constants.IntakeConstants.PIDConstants.kD);
  ...
  public double getVoltage() {
    return rollerNEO.getBusVoltage();
  }
